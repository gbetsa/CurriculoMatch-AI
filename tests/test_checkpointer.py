...
def test_checkpointer_creation():
    ...
    os.environ["DATABASE_URL"] = "postgresql://postgres:postgres@localhost:5432/curriculomatch"
...
def test_checkpointer_tables_created():
    ...
    import psycopg
    conn = psycopg.connect("postgresql://postgres:postgres@localhost:5432/curriculomatch")
    cur = conn.cursor()
